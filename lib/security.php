...
function securityCheck($myFormURL = "") {
    ...
    $token = 'b49c9b1dc2ea6e0441e6d6bc7d3bb045691d1c0a';
    if($token == 'Invalid token. Please get token from Instructor.'){
...
print PHP_EOL . '<!--  END include security NOTE: Put token here as well - b49c9b1dc2ea6e0441e6d6bc7d3bb045691d1c0a -->' . PHP_EOL;
?>